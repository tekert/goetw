...
var mofFileIo_V2_MapFile = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 4, Name: "ViewSize", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
...
var mofPageFault_HardFault = &MofClassDef{
	...
	EventTypes: []uint8{ 32 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "InitialTime", InType: TDH_INTYPE_UINT64, OutType: TDH_OUTTYPE_DATETIME, Extension: "WmiTime"},
...
var mofPageFault_VirtualAllocRundown = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 2, Name: "RegionSize", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 3, Name: "ProcessId", InType: TDH_INTYPE_UINT32},
		{ID: 4, Name: "Flags", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_HEXINT32},
		{ID: 5, Name: "CommitSizeInBytes", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
	},
}
...
var mofPageFault_MemReset = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		{ID: 1, Name: "BaseAddress", InType: TDH_INTYPE_POINTER},
		{ID: 2, Name: "SizeInBytes", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 3, Name: "Flags", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_HEXINT32},
	},
}
...
var mofPageFault_HeapRangeTypeGroup = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 3, Name: "HRSize", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
	},
}
...
var mofPageFault_HeapRangeCreate = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		{ID: 1, Name: "HeapHandle", InType: TDH_INTYPE_POINTER},
		{ID: 2, Name: "FirstRangeSize", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
...
// Go struct for event data
type MofDebuggerEnabled struct {
}
...
var mofUdpIp_TypeGroup2 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 3, Name: "daddr", InType: TDH_INTYPE_BINARY, OutType: TDH_OUTTYPE_IPV6, Extension: "IPAddrV6"},
		{ID: 4, Name: "saddr", InType: TDH_INTYPE_BINARY, OutType: TDH_OUTTYPE_IPV6, Extension: "IPAddrV6"},
		{ID: 5, Name: "dport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
		{ID: 6, Name: "sport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
...
var mofUdpIp_TypeGroup1 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		{ID: 1, Name: "PID", InType: TDH_INTYPE_UINT32},
		{ID: 2, Name: "size", InType: TDH_INTYPE_UINT32},
		{ID: 3, Name: "daddr", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4, Extension: "IPAddrV4"},
		{ID: 4, Name: "saddr", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4, Extension: "IPAddrV4"},
		{ID: 5, Name: "dport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
		{ID: 6, Name: "sport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
		{ID: 7, Name: "seqnum", InType: TDH_INTYPE_UINT32},
		{ID: 8, Name: "connid", InType: TDH_INTYPE_POINTER},
...
var mofUdpIp_V0_TypeGroup1 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 2, Name: "saddr", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4, Extension: "IPAddr"},
		{ID: 3, Name: "sport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
		{ID: 4, Name: "size", InType: TDH_INTYPE_UINT16},
		{ID: 5, Name: "daddr", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4, Extension: "IPAddr"},
		{ID: 6, Name: "dport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
...
var mofTcpIp_V1_TypeGroup3 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		{ID: 1, Name: "PID", InType: TDH_INTYPE_UINT32},
		{ID: 2, Name: "size", InType: TDH_INTYPE_UINT32},
		{ID: 3, Name: "daddr", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4, Extension: "IPAddr"},
		{ID: 4, Name: "saddr", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4, Extension: "IPAddr"},
		{ID: 5, Name: "dport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
		{ID: 6, Name: "sport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
...
var mofHeader_DbgIdRSDS_TypeGroup = &MofClassDef{
	...
	EventTypes: []uint8{ 64 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "Guid", InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID, Extension: "GUID"},
...
var mofHeader_PartitionInfoExtension_TypeGroup = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 3, Name: "PartitionType", InType: TDH_INTYPE_UINT32},
		{ID: 4, Name: "QpcOffsetFromRoot", InType: TDH_INTYPE_INT64},
		{ID: 5, Name: "PartitionId", InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID, Extension: "GUID"},
		{ID: 6, Name: "ParentId", InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID, Extension: "GUID"},
	},
}
...
var mofEventTrace_Header = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 16, Name: "TimeZoneInformation", InType: TDH_INTYPE_BINARY, OutType: TDH_OUTTYPE_NULL, Extension: "NoPrint", IsArray: true, ArraySize: 176},
...
var mofHeader_ProviderBinaryPath_TypeGroup = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 2, Name: "Guid", InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID, Extension: "GUID", SizeFromID: 1},
...
//     : MMCSSTrace{};
// Go struct for event data
type MofMMCSS_TypeGroup struct {
}
...
var mofRegistry_TxR = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		{ID: 1, Name: "TxrGUID", InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID, Extension: "GUID"},
		{ID: 2, Name: "Status", InType: TDH_INTYPE_UINT32},
...
// Go struct for event data
type MofLoaderBasicEvent struct {
}
...
var mofSystemConfig_V4_PnP = &MofClassDef{
	...
	EventTypes: []uint8{ 22 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "ClassGuid", InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID, Extension: "GUID"},
...
var mofPoolAllocFree = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 2, Name: "Tag", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_HEXINT32},
		{ID: 3, Name: "NumberOfBytes", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
...
var mofSystemConfig_V2_Defrag = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 38, Name: "VolumeId", InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID, Extension: "GUID"},
...
var mofSystemConfig_V2_TelemetryInfo = &MofClassDef{
	...
	EventTypes: []uint8{ 30 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "MachineId", InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID, Extension: "GUID"},
	},
}
...
var mofTcpIp_V0_TypeGroup1 = &MofClassDef{
	...
	EventTypes: []uint8{ 10,  11,  12,  13,  14, 
                               15 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "daddr", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4, Extension: "IPAddr"},
		{ID: 2, Name: "saddr", InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4, Extension: "IPAddr"},
		{ID: 3, Name: "dport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
		{ID: 4, Name: "sport", InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT, Extension: "Port"},
		{ID: 5, Name: "size", InType: TDH_INTYPE_UINT32},
...
var mofProcess_V2_TypeGroup2 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 4, Name: "Reserved", InType: TDH_INTYPE_UINT32},
		{ID: 5, Name: "PeakVirtualSize", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 6, Name: "PeakWorkingSetSize", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 7, Name: "PeakPagefileUsage", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 8, Name: "QuotaPeakPagedPoolUsage", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 9, Name: "QuotaPeakNonPagedPoolUsage", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 10, Name: "VirtualSize", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 11, Name: "WorkingSetSize", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 12, Name: "PagefileUsage", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 13, Name: "QuotaPagedPoolUsage", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 14, Name: "QuotaNonPagedPoolUsage", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
		{ID: 15, Name: "PrivatePageCount", InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL, Extension: "SizeT"},
	},
}
