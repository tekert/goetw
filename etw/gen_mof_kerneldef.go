...
var mofFileIo_V2_MapFile = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 4, Name: "ViewSize", NameW: []uint16{'V', 'i', 'e', 'w', 'S', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
...
var mofPageFault_HardFault = &MofClassDef{
	...
	EventTypes: []uint8{ 32 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "InitialTime", NameW: []uint16{'I', 'n', 'i', 't', 'i', 'a', 'l', 'T', 'i', 'm', 'e', 0}, InType: TDH_INTYPE_UINT64, OutType: TDH_OUTTYPE_DATETIME},
...
var mofPageFault_VirtualAllocRundown = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 2, Name: "RegionSize", NameW: []uint16{'R', 'e', 'g', 'i', 'o', 'n', 'S', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		...
		{ID: 5, Name: "CommitSizeInBytes", NameW: []uint16{'C', 'o', 'm', 'm', 'i', 't', 'S', 'i', 'z', 'e', 'I', 'n', 'B', 'y', 't', 'e', 's', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
	},
}
...
var mofPageFault_MemReset = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		{ID: 1, Name: "BaseAddress", NameW: []uint16{'B', 'a', 's', 'e', 'A', 'd', 'd', 'r', 'e', 's', 's', 0}, InType: TDH_INTYPE_POINTER},
		{ID: 2, Name: "SizeInBytes", NameW: []uint16{'S', 'i', 'z', 'e', 'I', 'n', 'B', 'y', 't', 'e', 's', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
...
var mofPageFault_HeapRangeTypeGroup = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 3, Name: "HRSize", NameW: []uint16{'H', 'R', 'S', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
	},
}
...
var mofPageFault_HeapRangeCreate = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		{ID: 1, Name: "HeapHandle", NameW: []uint16{'H', 'e', 'a', 'p', 'H', 'a', 'n', 'd', 'l', 'e', 0}, InType: TDH_INTYPE_POINTER},
		{ID: 2, Name: "FirstRangeSize", NameW: []uint16{'F', 'i', 'r', 's', 't', 'R', 'a', 'n', 'g', 'e', 'S', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
...
var mofUdpIp_TypeGroup2 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 3, Name: "daddr", NameW: []uint16{'d', 'a', 'd', 'd', 'r', 0}, InType: TDH_INTYPE_BINARY, OutType: TDH_OUTTYPE_IPV6},
		{ID: 4, Name: "saddr", NameW: []uint16{'s', 'a', 'd', 'd', 'r', 0}, InType: TDH_INTYPE_BINARY, OutType: TDH_OUTTYPE_IPV6},
		{ID: 5, Name: "dport", NameW: []uint16{'d', 'p', 'o', 'r', 't', 0}, InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT},
		{ID: 6, Name: "sport", NameW: []uint16{'s', 'p', 'o', 'r', 't', 0}, InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT},
...
var mofUdpIp_TypeGroup1 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		{ID: 1, Name: "PID", NameW: []uint16{'P', 'I', 'D', 0}, InType: TDH_INTYPE_UINT32},
		{ID: 2, Name: "size", NameW: []uint16{'s', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_UINT32},
		{ID: 3, Name: "daddr", NameW: []uint16{'d', 'a', 'd', 'd', 'r', 0}, InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4},
		{ID: 4, Name: "saddr", NameW: []uint16{'s', 'a', 'd', 'd', 'r', 0}, InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4},
		{ID: 5, Name: "dport", NameW: []uint16{'d', 'p', 'o', 'r', 't', 0}, InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT},
		{ID: 6, Name: "sport", NameW: []uint16{'s', 'p', 'o', 'r', 't', 0}, InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT},
		{ID: 7, Name: "seqnum", NameW: []uint16{'s', 'e', 'q', 'n', 'u', 'm', 0}, InType: TDH_INTYPE_UINT32},
		{ID: 8, Name: "connid", NameW: []uint16{'c', 'o', 'n', 'n', 'i', 'd', 0}, InType: TDH_INTYPE_POINTER},
...
var mofUdpIp_V0_TypeGroup1 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 2, Name: "saddr", NameW: []uint16{'s', 'a', 'd', 'd', 'r', 0}, InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4},
		{ID: 3, Name: "sport", NameW: []uint16{'s', 'p', 'o', 'r', 't', 0}, InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT},
		{ID: 4, Name: "size", NameW: []uint16{'s', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_UINT16},
		{ID: 5, Name: "daddr", NameW: []uint16{'d', 'a', 'd', 'd', 'r', 0}, InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4},
		{ID: 6, Name: "dport", NameW: []uint16{'d', 'p', 'o', 'r', 't', 0}, InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT},
...
var mofHeader_DbgIdRSDS_TypeGroup = &MofClassDef{
	...
	EventTypes: []uint8{ 64 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "Guid", NameW: []uint16{'G', 'u', 'i', 'd', 0}, InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID},
...
var mofHeader_PartitionInfoExtension_TypeGroup = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 3, Name: "PartitionType", NameW: []uint16{'P', 'a', 'r', 't', 'i', 't', 'i', 'o', 'n', 'T', 'y', 'p', 'e', 0}, InType: TDH_INTYPE_UINT32},
		{ID: 4, Name: "QpcOffsetFromRoot", NameW: []uint16{'Q', 'p', 'c', 'O', 'f', 'f', 's', 'e', 't', 'F', 'r', 'o', 'm', 'R', 'o', 'o', 't', 0}, InType: TDH_INTYPE_INT64},
		{ID: 5, Name: "PartitionId", NameW: []uint16{'P', 'a', 'r', 't', 'i', 't', 'i', 'o', 'n', 'I', 'd', 0}, InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID},
		{ID: 6, Name: "ParentId", NameW: []uint16{'P', 'a', 'r', 'e', 'n', 't', 'I', 'd', 0}, InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID},
	},
}
...
var mofEventTrace_Header = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 16, Name: "TimeZoneInformation", NameW: []uint16{'T', 'i', 'm', 'e', 'Z', 'o', 'n', 'e', 'I', 'n', 'f', 'o', 'r', 'm', 'a', 't', 'i', 'o', 'n', 0}, InType: TDH_INTYPE_BINARY, OutType: TDH_OUTTYPE_NULL, IsArray: true, ArraySize: 176},
...
var mofHeader_ProviderBinaryPath_TypeGroup = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 2, Name: "Guid", NameW: []uint16{'G', 'u', 'i', 'd', 0}, InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID, SizeFromID: 1},
...
var mofRegistry_TxR = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		{ID: 1, Name: "TxrGUID", NameW: []uint16{'T', 'x', 'r', 'G', 'U', 'I', 'D', 0}, InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID},
		{ID: 2, Name: "Status", NameW: []uint16{'S', 't', 'a', 't', 'u', 's', 0}, InType: TDH_INTYPE_UINT32},
...
var mofProcess_V1_TypeGroup1 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 6, Name: "UserSID", NameW: []uint16{'U', 's', 'e', 'r', 'S', 'I', 'D', 0}, InType: TDH_INTYPE_SID, OutType: TDH_OUTTYPE_STRING},
...
var mofProcess_V0_TypeGroup1 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 3, Name: "UserSID", NameW: []uint16{'U', 's', 'e', 'r', 'S', 'I', 'D', 0}, InType: TDH_INTYPE_SID, OutType: TDH_OUTTYPE_STRING},
...
var mofSystemConfig_V4_PnP = &MofClassDef{
	...
	EventTypes: []uint8{ 22 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "ClassGuid", NameW: []uint16{'C', 'l', 'a', 's', 's', 'G', 'u', 'i', 'd', 0}, InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID},
...
var mofProcess_Defunct_TypeGroup1 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 8, Name: "UserSID", NameW: []uint16{'U', 's', 'e', 'r', 'S', 'I', 'D', 0}, InType: TDH_INTYPE_SID, OutType: TDH_OUTTYPE_STRING},
...
var mofPoolAllocFree = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 2, Name: "Tag", NameW: []uint16{'T', 'a', 'g', 0}, InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_HEXINT32},
		{ID: 3, Name: "NumberOfBytes", NameW: []uint16{'N', 'u', 'm', 'b', 'e', 'r', 'O', 'f', 'B', 'y', 't', 'e', 's', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
...
var mofSystemConfig_V2_Defrag = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 38, Name: "VolumeId", NameW: []uint16{'V', 'o', 'l', 'u', 'm', 'e', 'I', 'd', 0}, InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID},
...
var mofSystemConfig_V2_TelemetryInfo = &MofClassDef{
	...
	EventTypes: []uint8{ 30 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "MachineId", NameW: []uint16{'M', 'a', 'c', 'h', 'i', 'n', 'e', 'I', 'd', 0}, InType: TDH_INTYPE_GUID, OutType: TDH_OUTTYPE_GUID},
	},
}
...
var mofTcpIp_V0_TypeGroup1 = &MofClassDef{
	...
	EventTypes: []uint8{ 10,  11,  12,  13,  14, 
                               15 },
	Properties: []MofPropertyDef{
		{ID: 1, Name: "daddr", NameW: []uint16{'d', 'a', 'd', 'd', 'r', 0}, InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4},
		{ID: 2, Name: "saddr", NameW: []uint16{'s', 'a', 'd', 'd', 'r', 0}, InType: TDH_INTYPE_UINT32, OutType: TDH_OUTTYPE_IPV4},
		{ID: 3, Name: "dport", NameW: []uint16{'d', 'p', 'o', 'r', 't', 0}, InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT},
		{ID: 4, Name: "sport", NameW: []uint16{'s', 'p', 'o', 'r', 't', 0}, InType: TDH_INTYPE_UINT16, OutType: TDH_OUTTYPE_PORT},
		{ID: 5, Name: "size", NameW: []uint16{'s', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_UINT32},
...
var mofProcess_V2_TypeGroup2 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 4, Name: "Reserved", NameW: []uint16{'R', 'e', 's', 'e', 'r', 'v', 'e', 'd', 0}, InType: TDH_INTYPE_UINT32},
		{ID: 5, Name: "PeakVirtualSize", NameW: []uint16{'P', 'e', 'a', 'k', 'V', 'i', 'r', 't', 'u', 'a', 'l', 'S', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 6, Name: "PeakWorkingSetSize", NameW: []uint16{'P', 'e', 'a', 'k', 'W', 'o', 'r', 'k', 'i', 'n', 'g', 'S', 'e', 't', 'S', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 7, Name: "PeakPagefileUsage", NameW: []uint16{'P', 'e', 'a', 'k', 'P', 'a', 'g', 'e', 'f', 'i', 'l', 'e', 'U', 's', 'a', 'g', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 8, Name: "QuotaPeakPagedPoolUsage", NameW: []uint16{'Q', 'u', 'o', 't', 'a', 'P', 'e', 'a', 'k', 'P', 'a', 'g', 'e', 'd', 'P', 'o', 'o', 'l', 'U', 's', 'a', 'g', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 9, Name: "QuotaPeakNonPagedPoolUsage", NameW: []uint16{'Q', 'u', 'o', 't', 'a', 'P', 'e', 'a', 'k', 'N', 'o', 'n', 'P', 'a', 'g', 'e', 'd', 'P', 'o', 'o', 'l', 'U', 's', 'a', 'g', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 10, Name: "VirtualSize", NameW: []uint16{'V', 'i', 'r', 't', 'u', 'a', 'l', 'S', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 11, Name: "WorkingSetSize", NameW: []uint16{'W', 'o', 'r', 'k', 'i', 'n', 'g', 'S', 'e', 't', 'S', 'i', 'z', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 12, Name: "PagefileUsage", NameW: []uint16{'P', 'a', 'g', 'e', 'f', 'i', 'l', 'e', 'U', 's', 'a', 'g', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 13, Name: "QuotaPagedPoolUsage", NameW: []uint16{'Q', 'u', 'o', 't', 'a', 'P', 'a', 'g', 'e', 'd', 'P', 'o', 'o', 'l', 'U', 's', 'a', 'g', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 14, Name: "QuotaNonPagedPoolUsage", NameW: []uint16{'Q', 'u', 'o', 't', 'a', 'N', 'o', 'n', 'P', 'a', 'g', 'e', 'd', 'P', 'o', 'o', 'l', 'U', 's', 'a', 'g', 'e', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
		{ID: 15, Name: "PrivatePageCount", NameW: []uint16{'P', 'r', 'i', 'v', 'a', 't', 'e', 'P', 'a', 'g', 'e', 'C', 'o', 'u', 'n', 't', 0}, InType: TDH_INTYPE_POINTER, OutType: TDH_OUTTYPE_NULL},
	},
}
...
var mofProcess_V3_TypeGroup1 = &MofClassDef{
	...
	Properties: []MofPropertyDef{
		...
		{ID: 5, Name: "ExitStatus", NameW: []uint16{'E', 'x', 'i', 't', 'S', 't', 'a', 't', 'u', 's', 0}, InType: TDH_INTYPE_INT32},
		{ID: 6, Name: "DirectoryTableBase", NameW: []uint16{'D', 'i', 'r', 'e', 'c', 't', 'o', 'r', 'y', 'T', 'a', 'b', 'l', 'e', 'B', 'a', 's', 'e', 0}, InType: TDH_INTYPE_POINTER},
		{ID: 7, Name: "UserSID", NameW: []uint16{'U', 's', 'e', 'r', 'S', 'I', 'D', 0}, InType: TDH_INTYPE_SID, OutType: TDH_OUTTYPE_STRING},
